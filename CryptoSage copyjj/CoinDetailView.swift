        ...
        VStack(spacing: 12) {
            ...
            HStack {
                Text("Market Cap")
                    ...
                    .foregroundColor(.gray)
                Spacer()
                Text(formatLargeNumber(coin.marketCapUsd ?? 0))
                    .font(.subheadline)
                    .fontWeight(.semibold)
                    .foregroundColor(.white)
            }
        ...
        VStack(spacing: 12) {
            ...
            HStack {
                Text("Circulating Supply")
                    .font(.subheadline)
                    .foregroundColor(coin.supply != nil ? .gray : .gray.opacity(0.5))
                Spacer()
                if let circ = coin.supply {
                    Text(formatLargeNumber(circ))
                        .font(.subheadline)
                        .fontWeight(.semibold)
                        .foregroundColor(.white)
                } else {
            ...
            HStack {
                Text("Rank")
                    .font(.subheadline)
                    .foregroundColor(coin.rank != nil ? .gray : .gray.opacity(0.5))
                Spacer()
